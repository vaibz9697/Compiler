...
term_prime   		: MUL factor term_prime {	$$ = insert_Node("term_prime", $1, $2, $3);	}
					...
					;	 
factor 		: FLOAT_ID {	$$ = insert_Node("factor", $1);	}
			| NUM_ID {	$$ = insert_Node("factor", $1);	}
...
assignment          : mutable EQUAL expression {	$$ = insert_Node("assignment", $1, $2, $3);	}
					...
					;
mutable				: ID {	$$ = insert_Node("mutable", $1);	}
...
isa_value				: ARM {	$$ = insert_Node("isa_value", $1);	}
						...
						;
clock_value				: NUM_ID {	$$ = insert_Node("clock_value", $1);	}
						;
...
start_pointnt 		: DQ start_value DQ {	$$ = insert_Node("start_pointnt", $1, $2, $3);	}
					...
					;
start_value 		: ID {	$$ = insert_Node("start_value", $1);	}
					;
...
channel_capacitynt 	: channel_capacity_value {	$$ = insert_Node("channel_capacitynt", $1);	}
					...
					;
channel_capacity_value 	: FLOAT_ID {	$$ = insert_Node("channel_capacity_value", $1);	}
						| NUM_ID {	$$ = insert_Node("channel_capacity_value", $1);	}
					;
...
job_id_value		:expression  {	$$ = insert_Node("job_id_value", $1);	}
					;
flops_required_value	:NUM_ID {	$$ = insert_Node("flops_required_value", $1);	}
						;
deadline_value		:expression {	$$ = insert_Node("deadline_value", $1);	}
					; 
mem_required_value	:NUM_ID {	$$ = insert_Node("mem_required_value", $1);	}
					;
affinity_value		: LS amd_value COMMA cdc_value COMMA mips_value COMMA dec_value RS  {	$$ = insert_Node("parameters_link_def", $1, $2, $3, $4, $5, $6, $7, $8, $9);	}
					;
amd_value		: FLOAT_ID {	$$ = insert_Node("amd_value", $1);	}
				| NUM_ID  {	$$ = insert_Node("amd_value", $1);	}
				;
cdc_value		: FLOAT_ID {	$$ = insert_Node("cdc_value", $1);	}
				| NUM_ID  {	$$ = insert_Node("cdc_value", $1);	}
				;
mips_value		: FLOAT_ID {	$$ = insert_Node("mips_value", $1);	}
				| NUM_ID  {	$$ = insert_Node("mips_value", $1);	}
				;
dec_value		: FLOAT_ID {	$$ = insert_Node("dec_value", $1);	}
				| NUM_ID  {	$$ = insert_Node("dec_value", $1);	}
				;
...
mem_value				: PRIMARY  {	$$ = insert_Node("mem_value", $1);	}
						...
						;
mem_size_value			: NUM_ID  {	$$ = insert_Node("mem_size_value", $1);	}
						| FLOAT_ID  {	$$ = insert_Node("mem_size_value", $1);	}
						;
